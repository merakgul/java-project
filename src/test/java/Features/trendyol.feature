...
Özellik: Trendyol Otomasyon Muhendisi Calismasi
  ...
  Senaryo: Trendyol Sitesi Urun Gorselleri Kontrolu ve Urun Sepete Eklenmesi
    ...
    Ve "Redmi Airdots Tws Bluetooth Basic 5.0 Kulaklık" urunu detayina gidilir
    Ve "Sepete Ekle" butonuna basilirsa
    O zaman "Redmi Airdots Tws Bluetooth Basic 5.0 Kulaklık" urununun sepete eklendigi gorulur
